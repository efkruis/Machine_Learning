...
**Responses 3.3**: *(1) Doctorate (2) 11+ years (3) Doctorate and 11+ years has the highest job performance score *.
...
**Response 3.4**: *No there does not appear much difference*.
...
**Responses 4.1**: *(1) 13356 (2) 78.3% (3) yes*.
...
**Responses 4.2**: *(1) Analysis sets have 10016 observations and the Assessment sets have 3340 observations (2) 10.7% (3) yes*.
...
**Responses 5.1**: *(1) There at 15 variables; 2 outcomes variables and 13 predictor variables (2) there is one factor variable (3) above*.
...
**Responses 6.1**: *(1) 4.15 (2) -1.55 (3) for every one unit change in emotional intelligence we expect a promotion to increase by 1.56 holding the other predictors constant. *.
...
**Responses 6.2**: *(1) 4.15 (2) 4.15  (3) -0.0759  (4)for every one unit change in proactiveness we expect promotion to increase by 1.33 holding the other predictors constant *.
